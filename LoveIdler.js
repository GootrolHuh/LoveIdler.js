...
var init = () => {
    ...
    // c2
    {
        ...
        c2 = theory.createUpgrade(1, currency, new ExponentialCost(5, Math.log2(2.2)));
   ...
   // c3
    {
        ...
        c3 = theory.createUpgrade(2, currency, new ExponentialCost(888, Math.log2(2.6)));
   ...
   // c4
    {
        ...
        let getInfo = (level) => "c_4=" + getC2(level).toString(0);
        c4 = theory.createUpgrade(3, currency, new ExponentialCost(1e5, Math.log2(3)));
...
var getPublicationMultiplier = (tau) => tau.pow(1.229) / BigNumber.THREE;
var getPublicationMultiplierFormula = (symbol) => "\\frac{{" + symbol + "}^{1.229}}{3}";
